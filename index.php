...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> | Savorio</title>
...
<body class="bg-light">
    ...
    <nav class="fw-bold navbar navbar-expand-lg navbar-dark position-fixed bg-danger bg-opacity-0 w-100" id="topNavBar" style="z-index:2">
        <div class="container">
            ...
            <div class="">
                <?php if(isset($_SESSION['user_id'])): ?>
                    <div class="dropdown">
                    <a class="btn btn-secondary bg-transparent border-0" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Hi, <?php echo $_SESSION['fullname'] ?></a>
                    <ul class="dropdown-menu">
                        <li>
                ...
                <?php else: ?>
                    <a class="btn btn-secondary bg-transparent border-0 me-1" href="./?page=login_registration" >
                    Login
                    </a>
                    <a class="btn btn-secondary bg-transparent border-0" href="./admin" >
                    Admin
                    </a>
                <?php endif; ?>
            </div>
    ...
    <div class="w-100 flex-grow-1" id="page-container">
        <?php 
