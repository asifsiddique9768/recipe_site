        ...
        <div class="col-12">
            <div class="row mx-0 d-flex justify-content-cente mb-2">
                ...
                <div class="input-group mb-3">
                    ...
                    <span class="input-group-text bg-danger" id="basic-addon2"><i class="text-white fa fa-search"></i></span>
                </div>
                </div>
            </div>
            ...
            <?php
                ...
                ?>
                <div class=" col wow px-3" data-wow-delay="<?php echo ($i > 0) ? $i:''; $i += .5; ?>s">
