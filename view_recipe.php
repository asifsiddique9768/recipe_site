...
<header>
    <div class="container my-5 d-flex flex-column justify-content-end align-items-end">
        <div class="flex-grow-1 d-flex justify-content-start align-items-center w-100">
            <div id="cat-title" class=" wow" data-wow-duration="1.2s"><span>Recipe of <?php echo  $title ?></div>
        </div>
    </div>
</header>
<div class="bg-light">
    <div class="container">
        ...
        <div class="col-md-7">
            ...
            ?>
            <div class="w-100 bg-white px-1 py-1 mb-2 shadow wow">
                <div class="w-100 d-flex align-items-center">
                    ...
                    <?php if((isset($_SESSION['user_id']) && $_SESSION['user_id'] == $row['user_id']) || (isset($_SESSION['admin_id']))): ?>
                        <button class="btn btn-sm btn-primary rounded-circle edit_comment mx-1" data-id="<?php echo $row['comment_id'] ?>"><i class="fa fa-edit"></i></button>
            ...
            <?php endwhile; ?>
            <hr>
            <form action="" id="comment-form" class="wow">
                ...
                <div class="form-group">
                    <div class="w-100 d-flex justify-content-end my-2">
                        <div class="col-auto">
                            <button class="btn btn-danger btn-sm rounded-0">Save</button>
                            <button class="btn btn-secondary btn-sm rounded-0" type="reset">Cancel</button>
                        </div>
                    </div>
                </div>
            </form>
