...
<div class="card">
    ...
    <div class="card-body">
        <table class="table table-hover table-striped table-bordered">
            ...
            <tbody>
                <?php 
                $sql = "SELECT r.*,u.fullname as author,c.name as cname FROM recipe_list r inner join user_list u on r.user_id = u.user_id inner join category_list c on r.category_id = c.category_id where r.user_id = '{$_SESSION['user_id']}' order by strftime('%s',r.date_created) desc";
                $qry = $conn->query($sql);
                $i = 1;
                ...
                <tr>
                    ...
                    <td class="text-center py-0 px-1">
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn btn-danger dropdown-toggle btn-sm rounded-0 py-0" data-bs-toggle="dropdown" aria-expanded="false">
                            Action
                            </button>
