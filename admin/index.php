...
if($_SESSION['type'] != 1 && in_array($page,array('maintenance','Vacancys','stocks'))){
    header("Location:./");
    exit;
}
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  <?php echo ($page == 'recipes')? 'active' : '' ?>" href="./?page=recipes">Recipes</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">User</a>
                    </li>
                    <?php if($_SESSION['type'] == 1): ?>
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'admin')? 'active' : '' ?>" aria-current="page" href="./?page=admin">Admin</a>
                    </li>
                    <li class="nav-item">
