                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        <div class="col-auto pe-1">
                            <span class="fa fa-th-list fs-4 text-primary"></span>
                            <span class="fs-5"><b>Food Categories</b></span>
                        </div>
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        <div class="col-auto pe-1">
                            <span class="fa fa-utensils fs-4 text-dark"></span>
                            <span class="fs-5"><b>Published Recipes</b></span>
                        </div>
                        <div class="col-auto flex-grow-1">
                            <div class="fs-6 text-end fw-bold">
                                <?php 
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        <div class="col-auto pe-1">
                            <span class="fa fa-user-friends fs-4 text-success"></span>
                            <span class="fs-5"><b>Users</b></span>
                        </div>
                        <div class="col-auto flex-grow-1">
                            <div class="fs-6 text-end fw-bold">
                                <?php 
        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        <div class="col-auto pe-1">
                            <span class="fa fa-users fs-4 text-primary"></span>
                            <span class="fs-5"><b>Admin Users</b></span>
                        </div>
                        <div class="col-auto flex-grow-1">
                            <div class="fs-6 text-end fw-bold">
                                <?php 
